...
![Procedural Objects Image](images/proc_object_overview.png)
![Dirt Variations Image](images/plate_vars.png)
...
The research reported in this paper has been partially supported by the German Research Foundation DFG, as a part of Collaborative Research Center (Sonderforschungsbereich) 1320 Project-ID 329551904 [EASE - Everyday Activity Science and Engineering](http://www.ease-crc.org/), University of Bremen.
The research was conducted in the subproject *R02 Multi-cue perception supported by background knowledge*.

Images generated by DiDiGen as well as neural networks trained by using these images are provided [online](https://www.informatik.uni-bremen.de/didigen-dataset/).

DiDiGen was originally developed for the master thesis ["I Cannot Believe All this Dirt! - Analysis of Synthetic Soil-Based Occlusion on Tableware Detectors with a Procedural Tableware Data Generator"](http://www.informatik.uni-bremen.de/agebv2/downloads/published/mach_thesis_24.pdf) by Philipp Mach in the computer science program of the University of Bremen.
